...
export default function MainSection2(props){
    ...
    // ============= TRANSFER FUNCTIONS =============
    const checkUser = async (numcompte) => {
    ...
    const updateSolde = async (amount) => {
    ...
    const addTransactions = async (updatedUser, beneficiary, amount) => {
        return new Promise((resolve) => {
            setTimeout(() => {
    ...
    const transfer = async (beneficiaryAccount, amount) => {
        setIsLoading(true);
        try {
    ...
    const effectuerRecharge = async (amount, cardNum) => {
        return new Promise((resolve) => {
            setTimeout(() => {
                const newUser = JSON.parse(JSON.stringify(user)); // Deep copy
    ...
    const addRechargeTransaction = async (amount) => {
        return new Promise((resolve) => {
            setTimeout(() => {
                const newUser = JSON.parse(JSON.stringify(user)); // Deep copy
    ...
    const recharge = async (amount, cardNum) => {
        setIsLoading(true);
